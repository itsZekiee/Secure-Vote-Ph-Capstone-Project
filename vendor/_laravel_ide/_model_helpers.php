...
namespace App\Models {
     ...
     * @property-read \App\Models\Partylist $partylist
     ...
     * @property int $id
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\ElectionForm2> $form2
     * @property-read int|null $form2_count
     * @method static \Illuminate\Database\Eloquent\Builder<ElectionForm1>|ElectionForm1 whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ElectionForm1>|ElectionForm1 whereTitle($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ElectionForm1>|ElectionForm1 whereOrganization($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ElectionForm1>|ElectionForm1 whereCategory($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ElectionForm1>|ElectionForm1 whereDescription($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ElectionForm1>|ElectionForm1 whereInstructions($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ElectionForm1>|ElectionForm1 whereStart($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ElectionForm1>|ElectionForm1 whereEnd($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ElectionForm1>|ElectionForm1 whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ElectionForm1>|ElectionForm1 whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ElectionForm1>|ElectionForm1 newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<ElectionForm1>|ElectionForm1 newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<ElectionForm1>|ElectionForm1 query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class ElectionForm1 extends \Illuminate\Database\Eloquent\Model
    {
        //
    }

    /**
     * App\Models\ElectionForm2
     *
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property array $candidates
     * @property string $position
     * @property mixed $form1_id
     * @property int $id
     * @property-read \App\Models\ElectionForm1 $form1
     * @method static \Illuminate\Database\Eloquent\Builder<ElectionForm2>|ElectionForm2 whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ElectionForm2>|ElectionForm2 whereForm1Id($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ElectionForm2>|ElectionForm2 wherePosition($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ElectionForm2>|ElectionForm2 whereCandidates($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ElectionForm2>|ElectionForm2 whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ElectionForm2>|ElectionForm2 whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ElectionForm2>|ElectionForm2 newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<ElectionForm2>|ElectionForm2 newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<ElectionForm2>|ElectionForm2 query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class ElectionForm2 extends \Illuminate\Database\Eloquent\Model
    {
        //
    }

    /**
     * App\Models\ElectionForm3
     *
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property array|null $admin_access_emails
     * @property string $allowed_domain
     * @property mixed $form1_id
     * @property int $id
     * @property-read \App\Models\ElectionForm1 $form1
     * @method static \Illuminate\Database\Eloquent\Builder<ElectionForm3>|ElectionForm3 whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ElectionForm3>|ElectionForm3 whereForm1Id($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ElectionForm3>|ElectionForm3 whereAllowedDomain($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ElectionForm3>|ElectionForm3 whereAdminAccessEmails($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ElectionForm3>|ElectionForm3 whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ElectionForm3>|ElectionForm3 whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ElectionForm3>|ElectionForm3 newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<ElectionForm3>|ElectionForm3 newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<ElectionForm3>|ElectionForm3 query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class ElectionForm3 extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<OAuthProvider>|OAuthProvider newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<OAuthProvider>|OAuthProvider newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<OAuthProvider>|OAuthProvider query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class OAuthProvider extends \Illuminate\Database\Eloquent\Model
    {
        //
    }

    /**
     * App\Models\Partylist
     *
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property int $id
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Partylist>|Partylist whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Partylist>|Partylist whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Partylist>|Partylist whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Partylist>|Partylist newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Partylist>|Partylist newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Partylist>|Partylist query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class Partylist extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @property-read int|null $oAuthProviders_count
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\UserVerification> $verifications
     ...
     *
     * @property-read \App\Models\User $user
     * @method static \Illuminate\Database\Eloquent\Builder<UserVerification>|UserVerification newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<UserVerification>|UserVerification newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<UserVerification>|UserVerification query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class UserVerification extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
